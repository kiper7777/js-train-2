...
function createURLObject(urlStr) {
  const createURLObject = new URL(urlStr);
  return createURLObject;
...
function encodeURLComponent(urlComponent) {
  const encodeURLComponent = encodeURIComponent(urlComponent);
...
function decodeURLComponent(urlComponent) {
  const decodeURLComponent = decodeURIComponent(urlComponent);
